        ...
        <table class="w-full border border-gray-300 text-sm">
          <thead class="bg-gray-100">
            <tr>
              ...
              <th class="px-4 py-2 border text-center ">Requisition no</th>
              <th class="px-4 py-2 border text-center ">Vendor Name</th>
              <th class="px-4 py-2 border text-center ">Phone</th>
              <th class="px-4 py-2 border text-center ">Address</th>
              <th class="px-4 py-2 border text-center ">Brand Name</th>
