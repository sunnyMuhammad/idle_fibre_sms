        ...
        <table class="w-full border border-gray-300 text-sm">
          <thead class="bg-gray-100">
            <tr>
              ...
              <th class="px-4 py-2 border text-center ">Parts No</th>
              <th class="px-4 py-2 border text-center ">Rack No</th>
              <th class="px-4 py-2 border text-center ">Column No</th>
              <th class="px-4 py-2 border text-center ">Row No</th>
              <th class="px-4 py-2 border text-center ">Floor Received</th>
              <th class="px-4 py-2 border text-center ">Total Received</th>
              <th class="px-4 py-2 border text-center ">Total Issue</th>
              <th class="px-4 py-2 border text-center ">Available Stock</th>
              <th class="px-4 py-2 border text-center ">Unit Type</th>
            </tr>
          </thead>
          <tbody>
            <tr v-for="(item, index) in props.items" :key="index" class="hover:bg-gray-50 border-1 print:border-2">
              <td class="px-4 py-2 border text-center">{{ index + 1 }}</td>
              <td class="px-4 py-2 border text-center">{{ item.product_name }}</td>
              <td class="px-4 py-2 border text-center">{{ item.category_name }}</td>
              <td class="px-4 py-2 border text-center">{{ item.parts_no }}</td>
              <td class="px-4 py-2 border text-center">{{ item.rack_no }}</td>
              <td class="px-4 py-2 border text-center">{{ item.column_no }}</td>
              <td class="px-4 py-2 border text-center">{{ item.row_no }}</td>
              <td class="px-4 py-2 border text-center">{{ item.floor_recieve }}</td>
              <td class="px-4 py-2 border text-center">{{item.total_received  }}</td>
              <td class="px-4 py-2 border text-center">{{ item.total_issue }}</td>
              <td class="px-4 py-2 border text-center">{{item.available_unit }}</td>
              <td class="px-4 py-2 border text-center">{{ item.unit_type }}</td>
            </tr>
          </tbody>
        </table>
      </div>
